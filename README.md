This is a simple function for Multi-dependent variable stepwise regression, using R. There is also a sub function to calculate the sweep transform of a matrix simply.
